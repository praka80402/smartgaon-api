...
public class OtpService {
    ...
    public OtpService(RestTemplate restTemplate, StringRedisTemplate redisTemplate) {
    ...
    public Map<String, Object> sendOtp(String mobile) {
        ...
        redisTemplate.opsForValue().set(redisKey(normalizedMobile), otp, Duration.ofMinutes(otpTtlMinutes));
    ...
    public Map<String, Object> verifyOtp(String mobile, String otp) {
        String normalizedMobile = normalizeMobile(mobile);
        String key = redisKey(normalizedMobile);
