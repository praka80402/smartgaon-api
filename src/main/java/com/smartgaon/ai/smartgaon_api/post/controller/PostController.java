//package com.smartgaon.ai.smartgaon_api.post.controller;
//
...
//import com.smartgaon.ai.smartgaon_api.post.service.PostService;
//
...
//    public ResponseEntity<String> repost(@PathVariable Long postId, @RequestParam Long userId) {
//        Post original = postRepository.findById(postId).orElseThrow();
//        User user = userRepo.findById(userId).orElseThrow();
//
//        Post repost = new Post();
//        repost.setContent("🔁 Reposted: " + original.getContent());
//        repost.setAuthorName(user.getFirstName() + " " + user.getLastName());
//        repost.setAuthorEmail(user.getEmail());
//        repost.setUser(user);
...
//    public ResponseEntity<String> shareOnWhatsApp(@PathVariable Long postId) {
//        Post post = postRepository.findById(postId).orElseThrow();
//        String encodedText = URLEncoder.encode(post.getContent(), StandardCharsets.UTF_8);
